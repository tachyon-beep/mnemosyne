...
export class SummaryPrompts {
   ...
   */
  private getBriefSystemPrompt(conversationType: string): string {
...
Provide only the summary text. No preamble, no explanations, no metadata.`;
   ...
   */
  private getStandardSystemPrompt(conversationType: string): string {
...
Provide only the summary text. No preamble, no explanations, no metadata.`;
   ...
   */
  private getDetailedSystemPrompt(conversationType: string): string {
...
Provide only the summary text with clear paragraph breaks. No preamble, no explanations, no metadata.`;
   ...
   */
  private getConversationTimespan(messages: Message[]): string | null {
