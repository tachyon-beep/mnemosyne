 ...
 */
export class GetContextSummaryTool extends BaseTool {
    providerManager;
     ...
     */
    async findRelevantConversations(params) {
        try {
     ...
     */
    async retrieveMessages(conversations, params) {
        try {
            const allMessages = [];
            ...
            for (const conversation of sortedConversations) {
                const messages = await this.messageRepository.findByConversationId(conversation.id, { limit: 100, orderBy: 'created_at', orderDir: 'ASC' });
     ...
     */
    generateFallbackSummary(messages, params) {
...
//# sourceMappingURL=GetContextSummaryTool.js.map