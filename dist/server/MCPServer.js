...
export class MCPServer {
     ...
     */
    async initializePerformanceManagement() {
    ...
    async initializeServices() {
        ...
        try {
            ...
            this.enhancedSearchEngine = new EnhancedSearchEngine(this.database, this.embeddingManager, this.basicSearchEngine);
    ...
    async initializeTools() {
        ...
        try {
            ...
            if (this.embeddingManager) {
                ...
                contextAssembler = new ContextAssembler(this.embeddingManager, messageRepository, summaryRepository);
            }
    ...
    async startPerformanceMonitoring() {
        ...
        try {
            if (this.memoryManager && this.database) {
                ...
                this.performanceOrchestrator = new PerformanceOrchestrator(this.database, this.memoryManager, {
    ...
    setupServerHandlers() {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            try {
                ...
                const result = await this.executeWithTimeout(() => this.toolRegistry.executeTool(name, args), this.config.toolTimeoutMs);
                ...
                if (this.performanceOrchestrator && this.performanceOrchestrator['performanceMonitor']) {
                    ...
                    this.performanceOrchestrator['performanceMonitor'].recordDatabaseMetric(`tool_${name}`, executionTime, resultCount);
                }
                if (result.success) {
