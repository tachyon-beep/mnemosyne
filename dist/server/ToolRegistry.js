 ...
 */
import { SaveMessageTool, SearchMessagesTool, GetConversationTool, GetConversationsTool, DeleteConversationTool, SemanticSearchTool, HybridSearchTool, GetContextSummaryTool, GetRelevantSnippetsTool, ConfigureLLMProviderTool } from '../tools/index.js';
/**
...
export class ToolRegistry {
    ...
    async initializeTools() {
        ...
        if (this.dependencies.databaseManager) {
            ...
            const { GetProactiveInsightsTool, CheckForConflictsTool, SuggestRelevantContextTool, AutoTagConversationTool } = await import('../tools/proactive/index.js');
        ...
        if (this.dependencies.databaseManager) {
            ...
            try {
                const { GetConversationAnalyticsTool, AnalyzeProductivityPatternsTool, DetectKnowledgeGapsTool, TrackDecisionEffectivenessTool, GenerateAnalyticsReportTool } = await import('../tools/analytics/index.js');
                // Import analytics repositories
                const { ConversationAnalyticsRepository, ProductivityPatternsRepository, KnowledgeGapsRepository, DecisionTrackingRepository } = await import('../analytics/repositories/index.js');
                // Import analyzers
     ...
     */
    registerTool(name, tool, registrationTime) {
 ...
 */
export async function createToolRegistry(dependencies) {
 ...
 */
export function createServerToolContext(requestId, client) {
    return {
