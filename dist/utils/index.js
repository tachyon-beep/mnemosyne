...
import { initializeErrorHandler } from './errorHandler.js';
// Error classes and utilities
export { 
// Base error class
AppError, 
// Specific error types
ValidationError, NotFoundError, ConflictError, DatabaseError, QuotaError, ProtocolError, AuthenticationError, AuthorizationError, RateLimitError, TimeoutError, ServiceUnavailableError, ConfigurationError, 
// Error utilities
...
export { 
// Logger classes
Logger, PerformanceTimer, 
// Enums and types
LogLevel, LOG_LEVEL_NAMES, 
// Logger functions
initializeLogger, getLogger, parseLogLevel, log } from './logger.js';
// Error handler
export { 
// Error handler class
MCPErrorHandler, 
// Initialization and access functions
initializeErrorHandler, getErrorHandler, 
// Convenience functions
handleError, handleValidationError, handleDatabaseError, withErrorHandling, executeMCPTool, createSuccessResponse, 
// Utility functions
isErrorResponse, extractErrorFromMCPResult } from './errorHandler.js';
 ...
 */
export async function wrapDatabaseOperation(operation, operationName, context) {
 ...
 */
export async function wrapOperation(operation, operationName, context) {
    const logger = getLogger();
    return logger.timeOperation(async () => {
        try {
