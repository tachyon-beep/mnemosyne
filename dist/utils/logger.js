...
export class Logger {
    ...
    performance(metrics, context) {
        this.log(LogLevel.INFO, `Performance: ${metrics.operation} took ${metrics.duration}ms`, undefined, { ...context, performance: metrics });
    }
    /**
     * Time an operation and log performance metrics
     */
    async timeOperation(operation, operationName, context) {
...
export function initializeLogger(config = {}) {
    ...
    const envConfig = {
        ...
        outputFormat: process.env.LOG_FORMAT || 'text',
 ...
 */
export const log = {
    debug: (message, metadata, context) => getLogger().debug(message, metadata, context),
    info: (message, metadata, context) => getLogger().info(message, metadata, context),
    warn: (message, metadata, context) => getLogger().warn(message, metadata, context),
    error: (message, error, metadata, context) => getLogger().error(message, error, metadata, context),
    performance: (metrics, context) => getLogger().performance(metrics, context),
    timeOperation: (operation, operationName, context) => getLogger().timeOperation(operation, operationName, context)
};
/**
