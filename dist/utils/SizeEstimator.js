...
export class SizeEstimator {
     ...
     */
    static compareEstimates(estimate1, estimate2) {
     ...
     */
    static estimateWithCache(value, cache = new Map(), options = {}) {
        if (cache.has(value)) {
     ...
     */
    static estimateValue(value, options, visited, context, depth) {
        // Track maximum depth
     ...
     */
    static estimateString(str, options, context) {
     ...
     */
    static estimateFunction(func, options, context) {
     ...
     */
    static estimateObject(obj, options, visited, context, depth) {
     ...
     * Estimate array size
     */
    static estimateArray(arr, options, visited, context, depth) {
     ...
     * Estimate Map size
     */
    static estimateMap(map, options, visited, context, depth) {
     ...
     * Estimate Set size
     */
    static estimateSet(set, options, visited, context, depth) {
     ...
     */
    static simplifiedEstimate(value) {
        try {
...
export class SizeUtils {
     ...
     */
    static isReasonableCacheSize(bytes, maxBytes = 10 * 1024 * 1024) {
        return bytes > 0 && bytes <= maxBytes;
    }
    /**
     * Calculate cache efficiency ratio
     */
    static calculateCacheEfficiency(dataSize, cacheSize) {
        if (cacheSize <= 0)
            return 0;
     ...
     */
    static estimateSerializationOverhead(value) {
        try {
...
//# sourceMappingURL=SizeEstimator.js.map